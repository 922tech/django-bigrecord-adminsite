...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('books', '0002_remove_book_no_book_serial_number'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='FilmActor',
            fields=[
                ('actor', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='books.actor')),
                ('last_update', models.DateTimeField()),
            ],
            options={
                'db_table': 'film_actor',
        ...
        migrations.CreateModel(
            name='FilmCategory',
            fields=[
                ('film', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='books.film')),
                ('last_update', models.DateTimeField()),
            ],
            options={
